...
def obter_freguesia(lat: float, lon: float):
    try:
        ...
        with conn.cursor(cursor_factory=RealDictCursor) as cur:
            ...
            cur.execute("""
                SELECT c.descr_concelho, i.taxa_envelhecimento, i.taxa_analfabetismo,
                       i.taxa_ensino_superior, i.taxa_desemprego, i.taxa_criminalidade,
                       i.taxa_mortalidade, i.valor_renda_absoluto, i.valor_renda_percentual,
